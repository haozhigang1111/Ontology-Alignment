...
parser.add_argument('--anchor_mapping_file', type=str, default='logmap_outputs/'+'FMA-NCI.txt')
parser.add_argument('--train_file', type=str, default='../class&path/'+flag+'/mappings_train.txt')
parser.add_argument('--valid_file', type=str, default='../class&path/'+flag+'/mappings_valid.txt')
...
parser.add_argument('--right_path_file', type=str, default='class&path/'+r_class+'_all_paths.txt',
                    help='all the paths that are pre-extracted')
parser.add_argument('--left_class_name_file', type=str, default='data/'+l_class+'_class_name.json',
                    help='pre-extracted the class names (rdfs:label and URI name) of each class')
parser.add_argument('--right_class_name_file', type=str, default='data/'+r_class+'_class_name.json',
                    help='pre-extracted the class names (rdfs:label and URI name) of each class')
...
if __name__ == "__main__":
    ...
    with open(FLAGS.anchor_mapping_file,encoding='utf8') as f:
