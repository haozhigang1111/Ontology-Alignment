...
parser.add_argument('--onto_file', type=str, default='data/NCI.owl', help='data/cmt.owl')
parser.add_argument('--name_file', type=str, default='data/NCI_class_name.json', help='data/cmt_class_name.json')
parser.add_argument('--path_file', type=str, default='data/NCI_all_paths.txt', help='data/cmt_all_paths.txt')
...
if __name__ == "__main__":
    ...
    json.dump(class_name, open(FLAGS.name_file, 'w',encoding='utf8'),ensure_ascii=False)
