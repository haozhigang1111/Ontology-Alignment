GS_file = 'logmap_output/gb2760_en-gb2762_en/GS_file1'

LogMap_ML_annotated_sample_file = 'gb2760-gb2762/ML1_samples_a.txt'
LogMap_annotated_sample_file = 'gb2760-gb2762/LogMap_samples_a_0.8_en.txt'
AML_annotated_sample_file = 'gb2760-gb2762/AML_samples_a_0.8_en.txt'
LogMap_GCN_annotated_sample_file = 'gb2760-gb2762/RDGCN1_samples_a.txt'
simase_GCN_annotated_sample_file = 'gb2760-gb2762/SGCN1_samples_a.txt'

LogMap_ML_output_mapping_file = 'gb2760-gb2762/ML1_output_mappings.txt'
LogMap_output_mapping_file = 'gb2760-gb2762/LogMap_output_mappings_0.8_en.txt'
AML_output_mapping_file = 'gb2760-gb2762/AML_output_mappings_0.8_en.txt'
LogMap_GCN_output_mapping_file = 'gb2760-gb2762/RDGCN1_output_mappings.txt'
simase_GCN_output_mapping_file ='gb2760-gb2762/SGCN1_output_mappings.txt'
...
LML_samples = set()
with open(LogMap_annotated_sample_file) as f:
...
samples = set()
filenames = [simase_GCN_annotated_sample_file, LogMap_annotated_sample_file,AML_annotated_sample_file,LogMap_ML_annotated_sample_file,LogMap_GCN_annotated_sample_file]
